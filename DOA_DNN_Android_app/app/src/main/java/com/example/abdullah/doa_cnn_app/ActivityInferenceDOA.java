...
public class ActivityInferenceDOA {
    ...
    private static final String MODEL_FILE =  "file:///android_asset/optimized_dnnfrozenModel_feb_19.pb";//frozen_model_2pool_3rnn.pb  optimized_frozenModel_feb_19.pb
